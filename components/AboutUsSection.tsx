...
export default function AboutUsSection({ }: Props) {
    return (
        <>
            <section className="about-one grid">
                <div className="about-one__shape-box-1 max-w-screen" style={{ maxWidth: "100vw" }}>
                        ...
                        <div className="col-xl-6">
                            <div className="about-one__left">
                                <div className="about-one__img-box wow slideInLeft" data-wow-delay="100ms"
                                    ...
                                    <div className="about-one__shape-4 zoominout md:block hidden">
